            ...
            >
                ...
                <defs>
                    <clipPath id="clipPath18">
                        <path d="M 0,29.875 H 115.876 V 0 H 0 Z"/>
                    </clipPath>
                </defs>
                    <g transform="matrix(1.7334 0 0 -1.7334 -.00034666 65)">
                    <g transform="matrix(1.2552,0,0,1.2552,-5.1046e-5,0)">
                        <g clip-path="url(#clipPath18)">
                            <g transform="translate(2.3002,12.64)">
                                <path
                                    d="m0 0c1.268 0 2.3 1.028 2.3 2.302 0 1.272-1.032 2.295-2.3 2.295-1.271 0-2.3-1.023-2.3-2.295 0-1.274 1.029-2.302 2.3-2.302"/>
                            </g>
                            <g
                                transform="translate(2.3002 .0077)">
                                <path
                                    d="m0 0c1.268 0 2.3 1.027 2.3 2.296s-1.032 2.303-2.3 2.303c-1.271 0-2.3-1.034-2.3-2.303s1.029-2.296 2.3-2.296"/>
                            </g>
                            <g
                                transform="translate(14.935,12.64)">
                                <path
                                    d="m0 0c1.27 0 2.298 1.028 2.298 2.302 0 1.272-1.028 2.295-2.298 2.295-1.271 0-2.301-1.023-2.301-2.295 0-1.274 1.03-2.302 2.301-2.302"/>
                            </g>
                            <g
                                transform="translate(14.935 .0077)">
                                <path
                                    d="m0 0c1.27 0 2.298 1.027 2.298 2.296s-1.028 2.303-2.298 2.303c-1.271 0-2.301-1.034-2.301-2.303s1.03-2.296 2.301-2.296"/>
                            </g>
                            <g
                                transform="translate(27.566,12.64)">
                                <path
                                    d="m0 0c1.274 0 2.303 1.028 2.303 2.302 0 1.272-1.029 2.295-2.303 2.295-1.271 0-2.296-1.023-2.296-2.295 0-1.274 1.025-2.302 2.296-2.302"/>
                            </g>
                            <g
                                transform="translate(2.3002,25.276)">
                                <path
                                    d="m0 0c1.268 0 2.3 1.029 2.3 2.299 0 1.272-1.032 2.298-2.3 2.298-1.271 0-2.3-1.026-2.3-2.298 0-1.27 1.029-2.299 2.3-2.299"/>
                            </g>
                            <g
                                transform="translate(14.935,25.276)">
                                <path
                                    d="m0 0c1.27 0 2.298 1.029 2.298 2.299 0 1.272-1.028 2.298-2.298 2.298-1.271 0-2.301-1.026-2.301-2.298 0-1.27 1.03-2.299 2.301-2.299"/>
                            </g>
                            <g
                                transform="translate(27.566,25.276)">
                                <path
                                    d="m0 0c1.274 0 2.303 1.029 2.303 2.299 0 1.272-1.029 2.298-2.303 2.298-1.271 0-2.296-1.026-2.296-2.298 0-1.27 1.025-2.299 2.296-2.299"/>
                            </g>
                            <g
                                transform="translate(27.566 .0077)">
                                <path
                                    d="m0 0c1.274 0 2.303 1.027 2.303 2.296s-1.029 2.303-2.303 2.303c-1.271 0-2.296-1.034-2.296-2.303s1.025-2.296 2.296-2.296"/>
                            </g>
                            <g
                                transform="translate(40.203,12.64)">
                                <path
                                    d="m0 0c1.269 0 2.3 1.028 2.3 2.302 0 1.272-1.031 2.295-2.3 2.295-1.271 0-2.298-1.023-2.298-2.295 0-1.274 1.027-2.302 2.298-2.302"/>
                            </g>
                            <g
                                transform="translate(40.203 .0077)">
                                <path
                                    d="m0 0c1.269 0 2.3 1.027 2.3 2.296s-1.031 2.303-2.3 2.303c-1.271 0-2.298-1.034-2.298-2.303s1.027-2.296 2.298-2.296"/>
                            </g>
                            <g
                                transform="translate(40.203,25.276)">
                                <path
                                    d="m0 0c1.269 0 2.3 1.029 2.3 2.302 0 1.265-1.031 2.297-2.3 2.297-1.271 0-2.298-1.032-2.298-2.297 0-1.273 1.027-2.302 2.298-2.302"/>
                            </g>
                            <g
                                transform="translate(55.663,10.829)">
                                <path
            ...
            <div>
                ...
                >
                    <i
                        ...
                        :class="collapsed ? 'w-full text-center text-2xl' : 'w-1/6'"
                    />
                    <span
                        class="text-md w-5/6"
